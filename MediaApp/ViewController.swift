...
//   LOOP FOR WHOLE DATA
      ...
      for x in 0...serverData.count-1{
      
            stackView.spacing = 20
        
            imageString = (serverData[x]["posters"] as!  [String])
...
//        POSTERS
        ...
        let stories = serverData[x]["story"] as? String ?? "DATA NOT AVAILABLE"
      ...
      //movie nameS
        ...
        movieName.text = (serverData[x]["title"] as!  String)
        stackView.addArrangedSubview(movieName)
        
      //video data
        
        let video = serverData[x]["trailers"] as!  [String]
      ...
      //audio
        ...
        let audio = serverData[x]["songs"]  as? [String] ?? ["DATA NOT AVAILABLE"]
...
//   /SERVER DATA SAVING IN SINGLETON CLASS
    ...
    SingletonFormsData.shared.serverData = data1!
